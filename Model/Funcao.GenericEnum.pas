...
begin
  if (Value < GetTypeData.MinValue) then
    ...
    if (Value > GetTypeData.MaxValue) then
...
constructor TEnum<T>.EEnum.CreateFmt(const Test: String; const Args: array of Const);
var
  Info: pTypeInfo;
begin
  Info := TypeInfo(T);
